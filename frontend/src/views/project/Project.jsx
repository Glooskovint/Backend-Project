...
const Project = ({ projectId }) => {
  ...
  const [descripcion, setDescripcion] = useState(project?.descripcion || "No se ha registrado la descripcion");
  const [objetivo_general, setObjetivoGeneral] = useState(project?.objetivo_general || "No se ha registrado objetivo general");
 const [objetivos, setObjetivos] = useState(Array.isArray(project?.objetivos) ? project.objetivos : [] );
...
navigator.clipboard.writeText(enlace)
  ...
  doc.setFont("Helvetica", "bold");
  doc.setFontSize(16);
  doc.text("ESQUEMA DE DESGLOSE DE TRABAJO (EDT)", pageWidth / 2, y, { align: "center" });
          ...
          <div class="project-body">
            ...
            <section class="resumen">
              ...
              <div class="descripcion">
                <input 
                  type="text" 
                  class="input-value" value={descripcion}
              ...
              <div class="objetivos">
                <div class="objetivo-general">
                  <input 
                    type="text" 
                    class="input-value" value={objetivo_general}
              ...
              <div class="acciones">
                ...
                <button class="btn-action" onClick={handleCompartir}><i class="fas fa-link"></i> Compartir</button>
