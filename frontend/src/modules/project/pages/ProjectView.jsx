...
export default function ProjectView() {
  ...
  useEffect(() => {
    if (currentProject) {
      setEditData({
        ...
        fecha_inicio: currentProject.fecha_inicio
          ? format(new Date(currentProject.fecha_inicio), "yyyy-MM-dd")
          : "",
        fecha_fin: currentProject.fecha_fin
          ? format(new Date(currentProject.fecha_fin), "yyyy-MM-dd")
          : "",
      });
    }
  }, [currentProject]);
  ...
  return (
    <>
      {showGantt && (
        <Gantt projectId={id} onClose={() => setShowGantt(false)} />
      )}
      {showEDT && <EDT projectId={id} onClose={() => setShowEDT(false)} />}
      {showPresupuesto && (
        <Presupuesto projectId={id} onClose={() => setShowPresupuesto(false)} />
      )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-text-main">
                    ...
                    <button
                      onClick={() => {
                        ...
                        setEditData({
                          ...
                          descripcion: currentProject.descripcion || "",
                          objetivo_general:
                            currentProject.objetivo_general || "",
                          fecha_inicio: currentProject.fecha_inicio
                            ? format(
                                new Date(currentProject.fecha_inicio),
                                "yyyy-MM-dd"
                              )
                            : "",
                          fecha_fin: currentProject.fecha_fin
                            ? format(
                                new Date(currentProject.fecha_fin),
                                "yyyy-MM-dd"
                              )
                            : "",
                        });
              ...
              <div className="flex items-center space-x-6 mt-4 text-sm text-text-secondary">
                <div className="flex items-center space-x-2">
                  ...
                  <span>
                    ...
                    -{" "}
                    {format(new Date(currentProject.fecha_fin), "dd MMM yyyy", {
                      locale: es,
                    })}
                  </span>
                </div>
        ...
        <div className="animate-fade-in">
          ...
          {activeTab === "tasks" && <TaskTable projectId={parseInt(id)} />}

          {activeTab === "members" && <MembersPanel projectId={parseInt(id)} />}
          ...
          {activeTab === "charts" && (
            ...
            <div className="card">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <button
                  className="p-6 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-primary-500 transition-colors"
