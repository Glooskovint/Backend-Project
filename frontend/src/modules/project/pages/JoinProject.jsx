  ...
  useEffect(() => {
    const handleJoin = async () => {
      ...
      try {
        ...
        console.log('[joinProject] Resultado:', result)
        setStatus("success");
        setMessage("Te has unido al proyecto correctamente");

        // Redirigir al proyecto después de 2 segundos
        setTimeout(() => {
          console.log("[navigate] Redirigiendo a /project/" + result.id);
      ...
      <div className="card max-w-md mx-auto text-center animate-fade-in">
        ...
        {status === "success" && (
          <>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¡Éxito!</h2>
